...
from stock.views import StockViewSet, ItemCategoryViewSet, StatusItemViewSet, LocalViewSet, EquipamentTypeViewSet, StockReadOnlyViewSet, StockStateView
...
urlpatterns = [
    ...
    path('stocks/infos/', StockStateView.as_view(), name='stock-stats')
]